...
E.find_prop = (obj, prop, val)=>E.find(obj,
  function(o){ return o[prop]===val; });
...
var has_unique = {};
E.has = (o, path)=>E.get(o, path, has_unique)!==has_unique;
E.own = (o, prop)=>Object.prototype.hasOwnProperty.call(o, prop);
  ...
  for (var prop in obj){
    if (E.own(obj, prop)){
      ...
      if (Array.isArray(obj[new_prop]))
        obj[new_prop].forEach(function(e){ E.escape_dotted_keys(e, repl); });
