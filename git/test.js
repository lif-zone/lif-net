...
describe('lib', function(){
  ...
  t('lif-zone/test_move', [
    ...
    [{seq: 2}, {file: '/a', add: true, git: {oid: '7780c82f7ec168abd6f2cd9f756058fcedad80f2', mode: '100644'}}, 16825],
    ...
    [{seq: 7, link: {l: 2}}, {file: '/dir1/b', content: 'l', git: {oid: '7780c82f7ec168abd6f2cd9f756058fcedad80f2', mode: '100644'}}, ''],
    ...
    [{seq: 9}, {file: '/dir1/c', add: true, git: {oid: 'bc9e3e7b4c0e05a8efb4942498c1afc86d431672', mode: '100644'}}, 16815],
    ...
    [{seq: 15}, {file: '/b/a', add: true, git: {oid: 'd6459e005434a49a66a3ddec92279a86160ad71f', mode: '100644'}}, 32],
  ...
  t('lif-zone/test_merge_simple', [
    ...
    [{seq: 2}, {file: '/main_file1', add: true, git: {oid: '8b137891791fe96927ad78e64b0aad7bded08bdc', mode: '100644'}}, 8],
    ...
    [{seq: 6}, {file: '/main_file2', add: true, git: {oid: '6c493ff740f9380390d5c9ddef4af18697ac9375', mode: '100644'}}, 47],
    ...
    [{seq: 8}, {file: '/branch_file1', add: true, git: {oid: '81feec21ec7e7b068f45ca64ca352e151331fcf2', mode: '100644'}}, 102],
    ...
    [{seq: 10, prev: 7}, {file: '/main_file3', add: true, git: {oid: '9df9148b245e84d4eefc7adfb9d747c2a3e6966a', mode: '100644'}}, 86],
    ...
    [{seq: 12, prev: 9}, {file: '/branch_file2', add: true, git: {oid: '00cd2033b090d099f771e57f39f23c858c22f651', mode: '100644'}}, 102],
    ...
    [{seq: 14, prev: 11, link: {l: 8}}, {file: '/branch_file1', content: 'l', git: {oid: '81feec21ec7e7b068f45ca64ca352e151331fcf2', mode: '100644'}}, ''],
    [{seq: 15, link: {l: 12}}, {file: '/branch_file2', content: 'l', git: {oid: '00cd2033b090d099f771e57f39f23c858c22f651', mode: '100644'}}, ''],
