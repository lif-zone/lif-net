...
let scroll = new LIF.Scroll({scroll: {pub_key, topic: 'http', domain: 'derry.lif.zone'}, decl: {ts}});
...
scroll.decl({http_record: {uri: '/derry.jpg', mime_type: 'image/jpeg'}, decl: {ts}, derry_img);
