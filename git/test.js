...
describe('lib', function(){
  ...
  t('lif-zone/test_move', [
    ...
    [{seq: 15}, {op: 'add', file: '/b/a', content: 1, git: {oid: 'd6459e005434a49a66a3ddec92279a86160ad71f', mode: '100644'}}, 32],
  ...
  // XXX: move commit to being of new files/modifications
    ...
    [{seq: 17}, {op: 'mod', file: '/main_file3', content: 1, git: {oid: '70350ee2b46550a16f7f3e4ab189620f89194ce3', mode: '100644'}}, 2647],
  ...
  _t('lif-rnd/test_branch incremental', 'lif-rnd/test_branch',
    ...
    [{seq: 4, link: 3}, {op: 'add', git_branch: 'main'}, ''],
    [{seq: 5, link: 4}, {op: 'add', git_branch: 'HEAD'}, ''],
    [{seq: 6, prev: 3, branch: 'branch1'}, {op: 'add', file: '/file1-branch1', content: 1, git: {oid: '8b137891791fe96927ad78e64b0aad7bded08bdc', mode: '100644'}}, 8],
    [{seq: 7, group: 1}, {op: 'commit', desc: 'Create file1-branch1\n', author: 'lif-rnd', ts: 1663110128, git: {oid: 'f748254314933c43f7992743c3ef8c04f7f0a70d', parent: ['cb42290303d83a9254397228e586f45539bbe010'], tree: '84a57ae7fb614f79a5da760c60c141fe1ade6412', author: {email: '79463501+lif-rnd@users.noreply.github.com', timestamp: 1670310128, timezoneOffset: -120}, committer: {name: 'GitHub', email: 'noreply@github.com', timestamp: 1670310128, timezoneOffset: -120}, gpgsig: '-----BEGIN PGP SIGNATURE-----\n\\n=Kt4c\n-----END PGP SIGNATURE-----\n'}}, ''],
    ...
    [{seq: 18, group: 1}, {op: 'commit', desc: 'Create file2 branch3\n', author: 'lif-rnd', ts: 1663111371, git: {oid: '9215645089772245e3583f257527e4ac40093607', parent: ['cb42290303d83a9254397228e586f45539bbe010'], tree: '4cd44cb973a7ddc82935cd8fa18a25eef1f51027', author: {email: '79463501+lif-rnd@users.noreply.github.com', timestamp: 1670311371, timezoneOffset: -120}, committer: {name: 'GitHub', email: 'noreply@github.com', timestamp: 1670311371, timezoneOffset: -120}, gpgsig: '-----BEGIN PGP SIGNATURE-----\n\\n=73h+\n-----END PGP SIGNATURE-----\n'}}, ''],
